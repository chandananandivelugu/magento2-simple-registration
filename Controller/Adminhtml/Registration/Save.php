...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Test\Simpleregistration\Model\Registration::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('test_simpleregistration_registration');
            ...
            $this->dataPersistor->set('test_simpleregistration_registration', $data);
